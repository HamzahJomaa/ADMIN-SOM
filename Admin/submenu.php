    ...
    <div class="scroll">
        <ul class="list-unstyled" data-link="Articles">
            ...
            if ($Qget_cat->num_rows > 0) {
                while ($row_cat = $Qget_cat->fetch_assoc()) {
            ?>
                    <li><a href="#"><span class="d-inline-block"><?php echo $row_cat["title"] ?></span></a></li>
            <?php
                }
            }
            ?>
        ...
        <ul class="list-unstyled" data-link="Pills" id="layouts">
            <li>
                <a href="pills.php">
                    <span class="d-inline-block">All Pills</span>
                </a>
            </li>
            <li>
                <a href="pills_add.php">
                    <span class="d-inline-block">Add New Pill</span>
                </a>
            </li>
            <li>
                <a href="pills_add.php">
                    <span class="d-inline-block">Edit Pill</span>
                </a>
            </li>
        </ul>
